...
export function useMetamask() {
  ...
  invariant(
    wagmiContext,
    `useMetamask() can only be used inside <Web3sdkioProvider />. If you are using <Web3sdkioSDKProvider /> you will have to use your own wallet-connection logic.`,
  );
  ...
  invariant(
    connector,
    "No connector found, please make sure you provide the InjectedConnector to your <Web3sdkioProvider />",
  );
