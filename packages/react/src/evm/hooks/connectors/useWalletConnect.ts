...
export function useWalletConnect() {
  ...
  invariant(
    wagmiContext,
    `useWalletConnect() can only be used inside <Web3sdkioProvider />. If you are using <Web3sdkioSDKProvider /> you will have to use your own wallet-connection logic.`,
  );
  ...
  invariant(
    connector,
    "WalletConnect connector not found, please make sure it is provided to your <Web3sdkioProvider />",
  );
