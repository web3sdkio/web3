...
export function useBalance(tokenAddress?: ContractAddress) {
  ...
  const { wallet, address, chainId } = useWeb3sdkioConnectedWalletContext();
...
export function useConnectedWallet() {
  return useWeb3sdkioConnectedWalletContext().wallet;
}
...
export function useAddress(): string | undefined {
  return useWeb3sdkioConnectedWalletContext().address;
}
...
export function useChainId(): number | undefined {
  return useWeb3sdkioConnectedWalletContext().chainId;
}
