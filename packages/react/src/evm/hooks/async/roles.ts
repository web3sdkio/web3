...
import type { Role, ValidContractInstance } from "@web3sdkio/sdk";
import type { Vote } from "@web3sdkio/sdk/dist/declarations/src/evm/contracts/prebuilt-implementations/vote";
