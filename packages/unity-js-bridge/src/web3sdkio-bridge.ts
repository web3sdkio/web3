...
class Web3sdkioBridge implements TWBridge {
  ...
  private activeSDK: Web3sdkioSDK | undefined;
  ...
  public async invoke(route: string, payload: string) {
    ...
    console.debug("web3sdkioSDK call:", route, parsedArgs);
