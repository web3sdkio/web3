...
export async function createContract({
  ...
  console.log(
    `Creating a new web3sdkio contracts project in ${chalk.green(root)}.`,
  );
  console.log();
  ...
  console.log(
    "    Compiles your contracts and detects web3sdkio extensions implemented on them.",
  );
  console.log();
  console.log(chalk.cyan(`  ${packageManager}${useYarn ? "" : " run"} deploy`));
  console.log("    Deploys your contracts with the web3sdkio deploy flow.");
  console.log();
  console.log(
    chalk.cyan(`  ${packageManager}${useYarn ? "" : " run"} release`),
  );
  console.log("    Releases your contracts with the web3sdkio release flow.");
  console.log();
