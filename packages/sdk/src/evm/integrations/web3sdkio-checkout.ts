...
import { SignatureDrop } from "@web3sdkio/contracts-js/dist/declarations/src/SignatureDrop";
...
export const PAPER_API_URL =
  `${PAPER_API_BASE}/${PAPER_API_VERSION}/platform/web3sdkio` as const;
