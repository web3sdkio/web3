...
export const EditionDropInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    ...
    return !contractInfo || contractInfo.version > 2
      ? (await import("@web3sdkio/contracts-js/dist/abis/DropERC1155.json"))
          .default
      : (
          await import(
            "@web3sdkio/contracts-js/dist/abis/DropERC1155_V2.json"
          )
        ).default;
  },
};
...
export const EditionInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    return (
      await import("@web3sdkio/contracts-js/dist/abis/TokenERC1155.json")
    ).default;
  },
};
...
export const MarketplaceInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    return (
      await import("@web3sdkio/contracts-js/dist/abis/Marketplace.json")
    ).default;
  },
};
...
export const MultiwrapInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    return (await import("@web3sdkio/contracts-js/dist/abis/Multiwrap.json"))
      .default;
  },
};
...
export const NFTCollectionInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    return (
      await import("@web3sdkio/contracts-js/dist/abis/TokenERC721.json")
    ).default;
  },
};
...
export const NFTDropInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    ...
    return !contractInfo || contractInfo.version > 3
      ? (await import("@web3sdkio/contracts-js/dist/abis/DropERC721.json"))
          .default
      : (
          await import(
            "@web3sdkio/contracts-js/dist/abis/DropERC721_V3.json"
          )
        ).default;
  },
};
...
export const PackInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    return (await import("@web3sdkio/contracts-js/dist/abis/Pack.json"))
      .default;
  },
};
...
export const SignatureDropInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    ...
    return !contractInfo || contractInfo.version > 4
      ? (
          await import(
            "@web3sdkio/contracts-js/dist/abis/SignatureDrop.json"
          )
        ).default
      : (
          await import(
            "@web3sdkio/contracts-js/dist/abis/SignatureDrop_V4.json"
          )
        ).default;
  },
};
...
export const SplitInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    return (await import("@web3sdkio/contracts-js/dist/abis/Split.json"))
      .default;
  },
};
...
export const TokenDropInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    const contractInfo = await getContractInfo(address, provider);
    return !contractInfo || contractInfo.version > 2
      ? (await import("@web3sdkio/contracts-js/dist/abis/DropERC20.json"))
          .default
      : (await import("@web3sdkio/contracts-js/dist/abis/DropERC20_V2.json"))
          .default;
  },
};
...
export const TokenInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    return (
      await import("@web3sdkio/contracts-js/dist/abis/TokenERC20.json")
    ).default;
  },
};
...
export const VoteInitializer = {
  ...
  getAbi: async (address: string, provider: ethers.providers.Provider) => {
    return (await import("@web3sdkio/contracts-js/dist/abis/VoteERC20.json"))
      .default;
  },
};
