...
import type { Multiwrap as MultiwrapContract } from "@web3sdkio/contracts-js";
import type ABI from "@web3sdkio/contracts-js/dist/abis/Multiwrap.json";
import {
  ITokenBundle,
  TokensWrappedEvent,
} from "@web3sdkio/contracts-js/dist/declarations/src/Multiwrap";
