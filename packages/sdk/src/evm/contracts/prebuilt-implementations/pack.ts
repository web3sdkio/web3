...
import type { Pack as PackContract } from "@web3sdkio/contracts-js";
import type ABI from "@web3sdkio/contracts-js/dist/abis/Pack.json";
import { PackUpdatedEvent } from "@web3sdkio/contracts-js/dist/declarations/src/IPack";
import {
  ITokenBundle,
  PackCreatedEvent,
  PackOpenedEvent,
} from "@web3sdkio/contracts-js/dist/declarations/src/Pack";
