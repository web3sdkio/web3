import DropERC1155_V2Abi from "@web3sdkio/contracts-js/dist/abis/DropERC1155_V2.json";
import IBurnableERC1155Abi from "@web3sdkio/contracts-js/dist/abis/IBurnableERC1155.json";
import IClaimableERC1155 from "@web3sdkio/contracts-js/dist/abis/IClaimableERC1155.json";
import DelayedRevealAbi from "@web3sdkio/contracts-js/dist/abis/IDelayedReveal.json";
import IDropMultiPhase1155 from "@web3sdkio/contracts-js/dist/abis/IDrop1155.json";
import IDropSinglePhase1155 from "@web3sdkio/contracts-js/dist/abis/IDropSinglePhase1155.json";
import IDropSinglePhase1155_V1 from "@web3sdkio/contracts-js/dist/abis/IDropSinglePhase1155_V1.json";
import Erc1155Abi from "@web3sdkio/contracts-js/dist/abis/IERC1155.json";
import Erc1155EnumerableAbi from "@web3sdkio/contracts-js/dist/abis/IERC1155Enumerable.json";
import ILazyMintAbi from "@web3sdkio/contracts-js/dist/abis/ILazyMint.json";
import IMintableERC1155Abi from "@web3sdkio/contracts-js/dist/abis/IMintableERC1155.json";
import MulticallAbi from "@web3sdkio/contracts-js/dist/abis/IMulticall.json";
import ISignatureMintERC1155Abi from "@web3sdkio/contracts-js/dist/abis/ISignatureMintERC1155.json";
