import DropERC721_V3Abi from "@web3sdkio/contracts-js/dist/abis/DropERC721_V3.json";
import IBurnableERC721Abi from "@web3sdkio/contracts-js/dist/abis/IBurnableERC721.json";
import IClaimableERC721 from "@web3sdkio/contracts-js/dist/abis/IClaimableERC721.json";
import DelayedRevealAbi from "@web3sdkio/contracts-js/dist/abis/IDelayedReveal.json";
import IDrop from "@web3sdkio/contracts-js/dist/abis/IDrop.json";
import IDropSinglePhase from "@web3sdkio/contracts-js/dist/abis/IDropSinglePhase.json";
import IDropSinglePhaseV1 from "@web3sdkio/contracts-js/dist/abis/IDropSinglePhase_V1.json";
import Erc721Abi from "@web3sdkio/contracts-js/dist/abis/IERC721.json";
import Erc721EnumerableAbi from "@web3sdkio/contracts-js/dist/abis/IERC721Enumerable.json";
import Erc721SupplyAbi from "@web3sdkio/contracts-js/dist/abis/IERC721Supply.json";
import ILazyMintAbi from "@web3sdkio/contracts-js/dist/abis/ILazyMint.json";
import IMintableERC721Abi from "@web3sdkio/contracts-js/dist/abis/IMintableERC721.json";
import MulticallAbi from "@web3sdkio/contracts-js/dist/abis/IMulticall.json";
import SignatureMintERC721Abi from "@web3sdkio/contracts-js/dist/abis/ISignatureMintERC721.json";
import SignatureMintERC721_V1Abi from "@web3sdkio/contracts-js/dist/abis/ISignatureMintERC721_V1.json";
import TieredDropAbi from "@web3sdkio/contracts-js/dist/abis/LazyMintWithTier.json";
