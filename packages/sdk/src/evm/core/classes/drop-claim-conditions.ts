...
import type { IDropClaimCondition_V2 } from "@web3sdkio/contracts-js/dist/declarations/src/IDropERC20_V2";
import type { IDropSinglePhase } from "@web3sdkio/contracts-js/src/DropSinglePhase";
import type { IClaimCondition } from "@web3sdkio/contracts-js/src/IDrop";
...
> {
  ...
  private metadata;
  private storage: Web3sdkioStorage;
